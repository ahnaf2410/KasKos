...
<aside id="sidebar" class="fixed inset-y-0 left-0 w-64 bg-[#1e293b] text-white flex flex-col justify-between z-50 transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out border-r border-slate-700">
    ...
    <div class="flex flex-col flex-1 overflow-y-auto">
        ...
        <nav class="flex-1 px-4 py-6 space-y-1.5">
            ...
            <a href="{{ route('admin.rooms.index') }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 {{ $active == 'rooms' ? 'bg-rose-500 text-white font-semibold shadow-md shadow-rose-500/20' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
