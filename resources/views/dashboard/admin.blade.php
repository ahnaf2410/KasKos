...
<div class="p-6 bg-gray-100 min-h-screen">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-6">
        @php
            $cards = [
                ['Total KasKos', 'Rp ' . number_format($totalKasKos, 0, ',', '.'), '💰', 'bg-emerald-600'],
                ['Kamar Terisi', $kamarTerisi, '🏠', 'bg-blue-600'],
                ['Kamar Kosong', $kamarKosong, '🚪', 'bg-orange-500'],
                ['Verifikasi', $verifikasi, '✔️', 'bg-red-600'],
            ];
        @endphp
